...
class NewsReprocessRegressionTests(unittest.TestCase):
    def test_reprocess_fixture_covers_matching_roundup_version_and_manual_overrides(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(by_id.loc["semiengineering_2006", "filter_status"], "keep")
            self.assertEqual(by_id.loc["semiengineering_2006", "filter_reason"], "manual_keep")
            self.assertEqual(by_id.loc["semiengineering_2007", "filter_status"], "reject")
            self.assertEqual(by_id.loc["semiengineering_2007", "filter_reason"], "manual_reject")
